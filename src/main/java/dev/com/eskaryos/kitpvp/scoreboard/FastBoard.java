...
public class FastBoard {
    ...
    static {
        try {
            ...
            SEND_PACKET = lookup.findVirtual(playerConnectionClass, "sendPacket",
            ...
            PACKET_SB_SERIALIZABLE_TEAM = sbTeamClass == null ? null : FastReflection.findPacketConstructor(sbTeamClass,
                    lookup);
